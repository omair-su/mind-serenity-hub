...
const sosSessions = [
  { id: "instant-calm", title: "Instant Calm", duration: 3, icon: "🌬️", desc: "Ultra-quick anxiety reset using 4-7-8 breathing.", gradient: "from-sky-500/12 via-blue-500/8 to-cyan-500/5",
    steps: [
  ...
  { id: "panic-protocol", title: "Panic Attack Protocol", duration: 5, icon: "🛡️", desc: "5-4-3-2-1 grounding for acute anxiety.", gradient: "from-rose-500/12 via-red-500/8 to-pink-500/5",
    steps: [
  ...
  { id: "overwhelm", title: "Overwhelm Relief", duration: 7, icon: "🌊", desc: "When everything feels like too much.", gradient: "from-teal-500/12 via-cyan-500/8 to-blue-500/5",
    steps: [
  ...
  { id: "anger", title: "Anger Management", duration: 8, icon: "🔥", desc: "Cool down heated emotions safely.", gradient: "from-amber-500/12 via-orange-500/8 to-red-500/5",
    steps: [
  ...
  { id: "insomnia", title: "Insomnia Reset", duration: 10, icon: "🌙", desc: "Can't sleep? This will help.", gradient: "from-indigo-500/12 via-violet-500/8 to-purple-500/5",
    steps: [
  ...
  { id: "pre-meeting", title: "Pre-Meeting Calm", duration: 5, icon: "💼", desc: "Before any important event.", gradient: "from-emerald-500/12 via-green-500/8 to-teal-500/5",
    steps: [
  ...
  { id: "grief", title: "Grief Support", duration: 10, icon: "💜", desc: "Hold difficult emotions with compassion.", gradient: "from-violet-500/12 via-purple-500/8 to-fuchsia-500/5",
    steps: [
  ...
  { id: "energy", title: "Quick Energy", duration: 5, icon: "⚡", desc: "Revitalize when you're dragging.", gradient: "from-yellow-500/12 via-amber-500/8 to-orange-500/5",
    steps: [
      ...
      <div className="space-y-8 animate-fade-in">
        <div>
          <div className="flex items-center gap-3 mb-2">
            <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-rose-500/20 to-amber-500/15 flex items-center justify-center">
        ...
        {activeSession && (
          <div className="bg-gradient-to-br from-primary/5 via-card to-gold/5 rounded-2xl border-2 border-primary/20 p-8 shadow-elevated">
            ...
            <div className="bg-gradient-to-br from-primary/5 to-sage/10 rounded-xl p-6 mb-6 border border-primary/10">
            ...
            <div className="flex items-center justify-center gap-3">
              <button onClick={() => { setRunning(!running); }}
                className="w-14 h-14 rounded-full bg-gradient-to-br from-primary to-primary/80 flex items-center justify-center shadow-soft">
                {running ? <Pause className="w-5 h-5 text-primary-foreground" /> : <Play className="w-5 h-5 text-primary-foreground" />}
              </button>
              <button onClick={nextStep} className="px-6 py-3 bg-gradient-to-r from-gold to-gold-dark text-white rounded-xl text-sm font-body font-semibold shadow-gold hover:shadow-lg transition-all">
                {stepIndex < activeSession.steps.length - 1 ? "Next Step" : "I Feel Better"}
              </button>
              <button onClick={() => { setActive(null); setRunning(false); }}
                className="px-4 py-3 bg-secondary rounded-xl text-sm font-body text-muted-foreground hover:bg-secondary/80 transition-all">
                End
              </button>
            </div>
        ...
        {!active && (
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {sosSessions.map(s => (
              <button key={s.id} onClick={() => startSession(s.id)}
                className={`text-left bg-gradient-to-br ${s.gradient} rounded-2xl border border-border/50 p-5 hover:shadow-card hover:-translate-y-1 transition-all duration-300 group`}>
        ...
        <div className="bg-gradient-to-r from-amber-500/8 to-orange-500/5 rounded-2xl p-5 border border-amber-500/15">
          <div className="flex items-start gap-3">
