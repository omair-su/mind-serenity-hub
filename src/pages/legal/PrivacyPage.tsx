  ...
  return (
    <LegalLayout title="Privacy Policy" updated="April 20, 2026">
      ...
      <ul>
        ...
        <li><strong>AI providers</strong> — Anthropic, Google, OpenAI process AI requests on our behalf under data processing agreements. Inputs are not used to train their models.</li>
