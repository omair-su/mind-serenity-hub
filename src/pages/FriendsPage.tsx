        ...
        <div className="rounded-3xl border border-border bg-card p-5 sm:p-6">
          ...
          <div className="mt-3 flex flex-col sm:flex-row gap-2">
            ...
            <button
              onClick={sendInvite}
              disabled={inviting}
              className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-[hsl(var(--sage-dark))] to-[hsl(var(--primary))] text-white font-body font-semibold text-sm hover:scale-105 active:scale-95 transition-transform disabled:opacity-60"
            >
              ...
              {incoming.map((r) => (
                <div key={r.id} className="flex items-center justify-between gap-3 rounded-2xl border border-border bg-card p-4">
                  ...
                  <div className="flex gap-2">
                    <button onClick={() => respond(r, "accepted")} aria-label="Accept" className="p-2 rounded-full bg-[hsl(var(--primary))] text-white">
                  ...
                  <div key={r.id} className="rounded-2xl border border-border bg-card p-4">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-3 min-w-0">
                        <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[hsl(var(--sage))] to-[hsl(var(--primary))] text-white flex items-center justify-center font-display font-bold flex-shrink-0">
