// Vagus Nerve Reset program page — vertical timeline of 7 days with cinematic
// video hero, "Why it works" expand, and progress tracking in localStorage.
...
export default function VagusNerveResetPage() {
  ...
  // Refresh on focus in case user completed a day in another tab
  useEffect(() => {
                    ...
                    <div className="pt-4">
                      ...
                      >
                        {locked ? (
                          ...
                          <>
                            <Play className="w-4 h-4 fill-current" /> {done ? "Practice again" : "Begin practice"}
                          </>
                        )}
                      </button>
                    </div>
