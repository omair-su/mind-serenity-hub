...
function AIRecommendationsPageInner() {
...
export default function AIRecommendationsPage() {
  return (
    <PremiumGate
      ...
      description="A personalized weekly plan generated by analyzing your mood patterns, practice history and goals — like having a meditation coach in your pocket."
      icon={Brain}
      gradient="from-gold/30 to-forest/20"
      previewItems={[
        "Daily session picks tuned to your mood",
        "Adaptive 7-day weekly plans",
        "Situation-specific micro-meditations",
        "Practice pattern analysis",
        "Goal-aligned course recommendations",
        "Weekly reflection prompts",
      ]}
    >
      <AIRecommendationsPageInner />
    </PremiumGate>
  );
}
