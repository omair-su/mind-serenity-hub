      ...
      >
        ...
        >
          <button
            ...
            className="absolute top-3 right-3 z-30 inline-flex items-center justify-center w-10 h-10 rounded-full bg-black/55 hover:bg-black/80 text-white backdrop-blur-md ring-1 ring-white/15 transition-colors focus:outline-none focus:ring-2 focus:ring-white/70"
          >
            <X className="w-5 h-5" />
          </button>
          ...
          <div className="relative aspect-video w-full bg-black">
            ...
            <div className="pointer-events-none absolute left-5 sm:left-8 bottom-20 sm:bottom-24 max-w-md">
              <div className="text-[10px] tracking-[0.25em] uppercase text-white/70 font-calm-body mb-2">
                Inside Willow Vibes
              </div>
              <div key={activeIdx} className="animate-fade-in">
                <div className="flex items-center gap-3">
                  {(() => {
                    ...
                    return (
                      <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/15 backdrop-blur-md ring-1 ring-white/20">
                        <Icon className="w-5 h-5 text-white" />
                      </span>
                    );
                  })()}
                  <div>
                    <div className="font-calm-display text-xl sm:text-2xl text-white font-semibold leading-tight">
                      {FEATURES[activeIdx].label}
                    </div>
                    <div className="font-calm-body text-sm text-white/75">
          ...
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-2 px-4 sm:px-6 py-4 bg-gradient-to-b from-[#0a1f3a] to-[#050f1f]">
            {FEATURES.map((f, i) => {
              ...
              return (
                ...
                >
                  <Icon className={`w-4 h-4 ${active ? "text-white" : "text-white/55"}`} />
